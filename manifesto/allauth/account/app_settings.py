...
EMAIL_REQUIRED = getattr(settings, "ACCOUNT_EMAIL_REQUIRED", True)

# After signing up, keep the user account inactive until the email
# address is verified
EMAIL_VERIFICATION = getattr(settings, "ACCOUNT_EMAIL_VERIFICATION", True)

# Login by email address, not username
EMAIL_AUTHENTICATION = getattr(settings, "ACCOUNT_EMAIL_AUTHENTICATION", True)
